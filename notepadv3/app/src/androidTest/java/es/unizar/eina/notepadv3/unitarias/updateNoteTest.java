...
public class updateNoteTest {
    ...
    @Test()
    public void test_P1(){
        result = mNotepad.getAdapter().updateNote(idNuevaNota, titulo, cuerpo, categoriaId, fecha, fecha);
    ...
    @Test()
    public void test_P2(){
        result = mNotepad.getAdapter().updateNote(-2, titulo, cuerpo, categoriaId, fecha, fecha);
    ...
    @Test()
    public void test_P3(){
        result = mNotepad.getAdapter().updateNote(idNuevaNota, null, cuerpo, categoriaId, fecha, fecha);
        assertEquals(result, false);
    }

    @Test()
    public void test_P4(){
        result = mNotepad.getAdapter().updateNote(idNuevaNota, "", cuerpo, categoriaId, fecha, fecha);
        assertEquals(result, false);
    }

    @Test()
    public void test_P5(){
        result = mNotepad.getAdapter().updateNote(idNuevaNota, titulo, null, categoriaId, fecha, fecha);
        assertEquals(result, false);
    }
}