...
public class Test {
    ...
    public static void ejecucionTest(NotesDbAdapter mDbHelper){
        long rowIdCorrecto = mDbHelper.createNote("Hola", "Soy una nota", -1, new Date(), new Date());
        Log.d("Prueba 1", "Valor devuelto: " + rowIdCorrecto);

        try{
            long rowIdIncorrecto = mDbHelper.createNote(null, "Soy una nota", -1, new Date(), new Date());
        ...
        try{
            long rowIdIncorrecto = mDbHelper.createNote("", "Soy una nota", -1, new Date(), new Date());
        ...
        try{
            long rowIdIncorrecto = mDbHelper.createNote("Hola", null, -1, new Date(), new Date());
        ...
        boolean result = mDbHelper.updateNote(rowIdCorrecto, "Hola", "Soy una nota", -1, new Date(), new Date());
        Log.d("Prueba 5", "Valor devuelto: " + result);

        try{
            result = mDbHelper.updateNote(-2, "Hola", "Soy una nota", -1, new Date(), new Date());
        ...
        try{
            result = mDbHelper.updateNote(rowIdCorrecto, null, "Soy una nota", -1, new Date(), new Date());
        ...
        try{
            result = mDbHelper.updateNote(rowIdCorrecto, "", "Soy una nota", -1, new Date(), new Date());
        ...
        try{
            result = mDbHelper.updateNote(rowIdCorrecto, "Hola", null, -1, new Date(), new Date());
        }catch(Exception e){
    ...
    public static void generarNotas(int cantidad, NotesDbAdapter mDbHelper){
        ...
        for(int i = 0; i < cantidad; i++){
            rowIdsCreados.add(mDbHelper.createNote("Nota " + i, "Soy una nota", -1, new Date(), new Date()));
        }
    ...
    public static void sobrecargaTest(NotesDbAdapter mDbHelper){
        ...
        for(int i = 0; i <= 29000000; i = i + 1000000){
            mDbHelper.createNote("Hola", new String(new char[i]).replace("\0", "a"), -1, new Date(), new Date());
