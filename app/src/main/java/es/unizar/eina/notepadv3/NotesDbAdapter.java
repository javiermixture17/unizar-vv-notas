...
public class NotesDbAdapter {
     ...
     */
    public long createNote(String title, String body, int id_category) {
    ...
    public boolean deleteCategory(long rowId){
        ...
        while(!notasCategoriaBorrar.isAfterLast()){
            ...
            updateNote(id_nota, notasCategoriaBorrar.getString(notasCategoriaBorrar.getColumnIndexOrThrow(KEY_TITLE)),
...
// practica 4
     ...
     */
    public boolean updateNote(long rowId, String title, String body, int id_categoria) {
        if(rowId > 0){
